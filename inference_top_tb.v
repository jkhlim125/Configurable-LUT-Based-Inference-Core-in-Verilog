...
module inference_top_tb;
    ...
    initial begin
        ...
        // --------------------------------------------------
        // Test 8: same input, different masks
        // Purpose:
        // - show that masking changes feature extraction
        // - show that final class can change even for same input
        // --------------------------------------------------
        @(negedge clk);
        in_valid = 1'b1;
        in_bits  = 32'h1234_ABCD;
        ...
        @(negedge clk);
        in_valid = 1'b1;
        in_bits  = 32'h1234_ABCD; // SAME INPUT
        mask_bus = 32'h0F0F_F0F0; // DIFFERENT MASK
        ...
        // --------------------------------------------------
        // SINGLE INPUT TEST (for latency visualization)
        // --------------------------------------------------
        #50;
